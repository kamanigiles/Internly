    ...
    <div className="overlay" onClick={onClose}>
      <div className="qv-modal" onClick={(e) => e.stopPropagation()}>
        <div className="qv-head">
          <div>
            <div className="qv-company">{semester.name || `Semester ${index + 1}`}</div>
...
function ScholarshipCard({ item, onEdit, onDelete, onStatusChange, onQuickView }) {
  ...
  return (
    <div className="card" onClick={onQuickView} role="button" tabIndex={0}>
  ...
  return (
    <div className="overlay" onClick={onClose}>
      <div className="qv-modal" onClick={(e) => e.stopPropagation()}>
        <div className="qv-head">
          <div>
            <div className="qv-company">{item.name || "Untitled scholarship"}</div>
  ...
  return (
    <div className="scholarships-page">
      ...
      <div className="controls-row">
        <div className="search-box">
          <Search size={15} strokeWidth={2.2} />
          <input value={query} onChange={(e) => setQuery(e.target.value)} placeholder="Search by name or sponsor" />
        </div>
        <div className="chip-filters">
...
function VolunteerModal({ draft, setDraft, isEditing, onCancel, onSave }) {
  ...
  return (
    <div className="overlay" onClick={onCancel}>
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        <div className="modal-head">
          <h2>{isEditing ? "Edit volunteer opportunity" : "Add volunteer opportunity"}</h2>
          <button className="icon-btn" onClick={onCancel} aria-label="Close"><X size={16} /></button>
        </div>
  ...
  return (
    <div className="overlay" onClick={onClose}>
      <div className="qv-modal" onClick={(e) => e.stopPropagation()}>
        <div className="qv-head">
          <div>
            <div className="qv-company">{item.organization || "Untitled organization"}</div>
  ...
  return (
    <div className="scholarships-page">
      ...
      <div className="controls-row">
        <div className="search-box">
          <Search size={15} strokeWidth={2.2} />
          <input value={query} onChange={(e) => setQuery(e.target.value)} placeholder="Search by organization or role" />
        </div>
        <div className="chip-filters">
  ...
  return (
    <div className="games-page">
      <div className="dashboard-welcome">
        <h2 className="dashboard-welcome-title">Take a brain break</h2>
...
function Card({ item, onEdit, onDelete, onStatusChange, onQuickView, wide }) {
  ...
  return (
    <div className={`card ${wide ? "card-wide" : ""}`} onClick={onQuickView} role="button" tabIndex={0}>
      <div className="card-top">
        <div className="card-title">
  ...
  return (
    <div className="overlay" onClick={onClose}>
      <div className="qv-modal" onClick={(e) => e.stopPropagation()}>
        <div className="qv-head">
          <div>
            <div className="qv-company">{item.company}</div>
...
function EditModal({ draft, setDraft, onCancel, onSave }) {
  ...
  return (
    <div className="overlay" onClick={onCancel}>
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        <div className="modal-head">
          <h2>{draft.id ? "Edit internship" : "Add internship"}</h2>
          <button className="icon-btn" onClick={onCancel} aria-label="Close"><X size={16} /></button>
        </div>
...
.view-tabs-divider { width: 1px; height: 18px; background: rgba(255,255,255,0.35); margin: 0 2px; }
...
.qv-company { font-family: 'Fraunces', serif; font-size: 19px; font-weight: 600; }
