...
function SettingsPage({ logoId, onChangeLogo, account, onUpdateAccount, onSignOut, onDeleteAccount, gpaSettings, onUpdateGpaSettings }) {
      ...
      {account && (
        <div className="settings-section settings-section-danger">
          ...
          <p className="settings-sub">
            ...
            and volunteering. This can't be undone.
          </p>
          {confirmDeleteAccount ? (
            <>
              ...
              <div className="settings-actions">
                <button className="btn btn-ghost" onClick={() => { setConfirmDeleteAccount(false); setDeleteConfirmText(""); }}>
                  Cancel
                </button>
                <button
